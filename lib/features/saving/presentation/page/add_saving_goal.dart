...
class _AddSavingGoalState extends State<AddSavingGoal> {
  ...
  Widget build(BuildContext context) {
    return BlocConsumer<SavingCubit, SavingState>(
          ...
          child: Column(
            ...
            children: [
              ...
              AppFormField(
                ...
                fillColor: AppColor.primaryLight.withAlpha(50),
                validator:  (value) {
                  return context.read<SavingCubit>().validateGoal(value ?? '');
                },
              ),
                ...
                children: [
                  ...
                  Expanded(
                    child: AppFormField(
                      ...
                      validator:  (value) {
                        return context.read<SavingCubit>().validateTargetAmount(value ?? '');
                      },
                    ),
                  ),
                ],
