...
class AppTheme {
  static final ThemeData lightTheme = ThemeData(
    useMaterial3: true,
    colorScheme: ColorScheme.fromSeed(seedColor: AppColor.primary, brightness: Brightness.light),
    ...
    appBarTheme: const AppBarTheme(
      ...
      titleTextStyle: TextStyle(color: AppColor.textPrimary, fontSize: 20, fontWeight: FontWeight.bold),
    ),
  ...
  static final ThemeData darkTheme = ThemeData(
    ...
    appBarTheme: const AppBarTheme(
      ...
      titleTextStyle: TextStyle(color: AppColor.background, fontSize: 20, fontWeight: FontWeight.bold),
    ),
    elevatedButtonTheme: ElevatedButtonThemeData(
      style: ElevatedButton.styleFrom(
        backgroundColor: AppColor.primary,
